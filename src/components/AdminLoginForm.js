                        ...
                        <div className='form-col col'>
                            <div className="card-body">
                                ...
                                <FormGroup>
                                    ...
                                    <h5 class="widget-title" style={{"margin-bottom": "20px"}}> Don't have an account? <Link to='/userLoginPage' style={{backgroundColor:"white"}}>SignUp</Link>  </h5>
                                </FormGroup>
                                </form>
                            </div>
                        </div>
